...
class ReviewFeedback extends Component {
    ...
    nextPage = () => {
        ...
        this.props.dispatch({type: 'SET_FEEDBACK', payload: [this.props.reduxState.pageOneReducer,
            this.props.reduxState.pageTwoReducer,this.props.reduxState.pageThreeReducer,
            this.props.reduxState.pageFourReducer]});
    }
